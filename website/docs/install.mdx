...
Remarklet can be installed as an NPM package or used via a CDN. It can also be used as a [bookmarklet](./bookmarklet) in your browser, allowing for quick access to its features on public web pages.
