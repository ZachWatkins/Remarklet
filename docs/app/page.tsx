                ...
                <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
                    <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
                        ...
                        <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
                            Remarklet adds drag-and-drop, resize, and text editing capabilities to
                            any web page. Empower your users with intuitive visual editing without
                ...
                <section className="container space-y-6 py-8 md:py-12 lg:py-24" id="features">
                    <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
                        ...
                        <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                            Remarklet provides a suite of intuitive editing tools that work on any
                            web page. No complex setup required.
                        </p>
                    </div>
                    <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
                        <div className="relative overflow-hidden rounded-lg border bg-background p-6">
                            ...
                            <div className="space-y-2 pt-6">
                                ...
                                <p className="text-muted-foreground">
                                    Easily move elements around the page with intuitive drag and
                                    drop functionality.
                                </p>
                            </div>
                        </div>
                        <div className="relative overflow-hidden rounded-lg border bg-background p-6">
                            ...
                            <div className="space-y-2 pt-6">
                                ...
                                <p className="text-muted-foreground">
                                    Adjust the size of any element with simple resize handles.
                                    Perfect for images, containers, and more.
                                </p>
                            </div>
                        </div>
                        <div className="relative overflow-hidden rounded-lg border bg-background p-6">
                            ...
                            <div className="space-y-2 pt-6">
                                ...
                                <p className="text-muted-foreground">
                                    Click to edit text content directly on the page. What you see is
                                    what you get.
                                </p>
                            </div>
                        </div>
                        <div className="relative overflow-hidden rounded-lg border bg-background p-6">
                            ...
                            <div className="space-y-2 pt-6">
                                ...
                                <p className="text-muted-foreground">
                                    Remarklet is designed to be lightweight and performant, with
                        ...
                        <div className="relative overflow-hidden rounded-lg border bg-background p-6">
                            ...
                            <div className="space-y-2 pt-6">
                                ...
                                <p className="text-muted-foreground">
                                    Add Remarklet to any project with just a few lines of code. No
                        ...
                        <div className="relative overflow-hidden rounded-lg border bg-background p-6">
                            ...
                            <div className="space-y-2 pt-6">
                                ...
                                <p className="text-muted-foreground">
                                    Remarklet is open source and free to use. Contribute to the
                                    project on GitHub.
                                </p>
                            </div>
                        </div>
...
`}</code>
                            ...
                            <div className="flex flex-col items-center gap-2 rounded-lg border bg-background p-6 text-center">
                                ...
                                <p className="text-muted-foreground">
                                    Remarklet provides intuitive controls indicated by their mouse
                                    cursor and element outlines. No training required.
                                </p>
                            </div>
                        </div>
                    </div>
